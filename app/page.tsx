    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-12">
      <div className="flex flex-col items-center justify-center space-y-12 max-w-4xl mx-auto px-4">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-4xl font-bold">Welcome to the CCDS Investment Club</h1>
          <p className="text-xl">
        ...
        {/* Sponsors Section */}
        <section className="w-full py-8 border-t border-gray-800">
          <h2 className="text-2xl font-semibold text-center mb-2">Our Sponsors</h2>
          <p className="text-gray-400 text-center mb-6 text-sm">Made possible by the generosity of our sponsors.</p>
